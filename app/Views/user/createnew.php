...
<div class="page-content">
    ...
    <div class="page-heading">
        <h2 class="my-4"><b>Create New</b></h2>
        <p>Buat Shortlink</p>
    </div>
	    ...
	    <form id="shortenForm" action="<?= base_url('/shortener/shorten'); ?>" method="post" class="links">
		    ...
		    <div style="display:none">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-secondary text-white">s.pu.go.id/</span>
                            <input type="text" class="form-control form-control-lg" id="alias_url" name="alias_url"
                                placeholder="https://s.pu.go.id/Pertemuan" oninput="checkInput()">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select form-select-lg" id="expiry" name="expiry" required>
                            <option value="" disabled selected>Pilih waktu expired</option>
