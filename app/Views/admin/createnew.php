        ...
        <div class="col-12 col-lg-15">
            <div class="row">
                <form id="shortenForm" action="<?= base_url('/shortener/shorten'); ?>" method="post" class="links">
                    ...
                    <label for="expiry" class="form-label">(Mandatory) Pilih Waktu Expired Shortlink</label>
		    ...
		    <div class="form-group">
                        <div class="g-recaptcha" data-sitekey="6LfpATkqAAAAABJwl8G0CtxARTZgh9WyOxAEMcn8" required></div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-danger text-white">
            <div class="modal-header justify-content-center">
                ...
                <h5 class="modal-title text-white text-center" id="virusTotalModalLabel">
                    <i class="bi bi-exclamation-triangle-fill"></i> PERINGATAN
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                URL yang Anda masukkan terdeteksi tidak aman.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Close</button>
            </div>
